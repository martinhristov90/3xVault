...
resource "aws_iam_role" "vault_server_role" {
  ...
  managed_policy_arns = [aws_iam_policy.vault_kms_auto_unseal_policy.arn, aws_iam_policy.vault_raft_auto_join_policy.arn, aws_iam_policy.vault_aws_auth_policy.arn, aws_iam_policy.vault_aws_secret_policy.arn, aws_iam_policy.vault_s3_raft_snapshot_policy.arn]
